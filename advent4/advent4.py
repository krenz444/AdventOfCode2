items0 = """gbc-frperg-pubpbyngr-znantrzrag-377[rgbnp]
...
items1 = """aaaaa-bbb-z-y-x-123[abxyz]
...
for item in items1.split('\n'):
    ...
    import operator
    sorted_alph = sorted(map.items(), key=operator.itemgetter(0))

    print sorted_alph
    sorted_x = sorted(sorted_alph, key=operator.itemgetter(1), reverse = True)
